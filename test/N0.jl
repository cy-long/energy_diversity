...
ecs_total = [ecosys_config(K=4, S_type=:total, N0_param = N0, ϵ_param=0.0, seed=42) for N0 in [1.0, sqrt(5), 5.0]];
...
ecs_indiv = [ecosys_config(K=4, S_type=:indiv, N0_param = N0, ϵ_param=0.0, seed=42) for N0 in [1.0, sqrt(5), 5.0]];
