...
function show_all_counts(all_counts)
    ...
    plt = plot(size=(160,100), grid=false);
...
pl_E = show_rep_communities(results_K, 1, 1.2)
pl_E
# savefig(pl_E, "figures/most_least_occur.svg")
...
# savefig(pl_F, "figures/peak_distributions.svg")